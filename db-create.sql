...
DROP TABLE IF EXISTS categories, friends, posts, posts_tags, posts_users, tags, tags_users, threads, threads_users, users;
...
CREATE TABLE users(
                      ...
                      Password CHAR(128),
                      Salt CHAR(88),
                      Avatar_path VARCHAR(125) NOT NULL DEFAULT '/img/avatars/default.png',
